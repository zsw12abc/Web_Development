	...
	?>
			<div class="userpro-admin-head">
				<div class="userpro-admin-left">
					...
					<span class="userpro-admin-span"><?php if (get_option('userpro_activated')) { _e('Thank you for activating UserPro!','userpro'); } else { _e('This copy is fully activated. by HaselBiscuit','userpro'); } ?></span>
				</div>
				<div class="userpro-admin-right">
					...
					<a href="http://bestblackhatforum.com/Thread-GET-UPDATE-UserPro-User-Profiles-with-Social-Login-v1-0-86-Full-Only-in-BBHF" class="button button-primary"><?php _e('Download Latest in BBHF','userpro'); ?></a>
				</div>
				<div class="clear"></div>
			</div>
	<?php
