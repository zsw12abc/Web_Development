<?php
	...
	function userpro_enqueue_scripts(){
		...
		if ( userpro_get_option('googlefont') && !userpro_get_option('customfont') ) {
			wp_register_style('userpro_google_font', is_ssl() ? 'https' : 'http' . '://fonts.googleapis.com/css?family='.userpro_get_option('googlefont').':400,400italic,700,700italic,300italic,300');
